...
duk_ret_t readEvent(duk_context *ctx) {
  ...
  switch(ev[0].type){
    ...
    case AppEvent::kMouseMove:
      ...
      duk_push_number(ctx, ev[0].arg.mouse_move.x);
      duk_put_prop_string(ctx, -2, "x");

      duk_push_number(ctx, ev[0].arg.mouse_move.y);
      duk_put_prop_string(ctx, -2, "y");

      duk_push_number(ctx, ev[0].arg.mouse_move.dx);
      duk_put_prop_string(ctx, -2, "dx");

      duk_push_number(ctx, ev[0].arg.mouse_move.dy);
      duk_put_prop_string(ctx, -2, "dy");

      duk_push_number(ctx, ev[0].arg.mouse_move.buttons);
    ...
    case AppEvent::kMouseButton:
      ...
      duk_push_number(ctx, ev[0].arg.mouse_button.x);
      duk_put_prop_string(ctx, -2, "x");

      duk_push_number(ctx, ev[0].arg.mouse_button.y);
      duk_put_prop_string(ctx, -2, "y");

      duk_push_number(ctx, ev[0].arg.mouse_button.button);
    ...
    case AppEvent::kTimerTimeout:
      ...
      duk_push_number(ctx, ev[0].arg.timer.value);
    ...
    case AppEvent::kKeyPush:
      ...
      duk_push_number(ctx, ev[0].arg.keypush.modifier);
      duk_put_prop_string(ctx, -2, "modifier");

      duk_push_number(ctx, ev[0].arg.keypush.keycode);
